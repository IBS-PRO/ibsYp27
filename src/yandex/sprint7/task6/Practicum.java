...
public class Practicum {
    ...
    // запросите у пользователя его координаты (долгота и широта) и
    ...
    public static void main(String[] args){
        ...
        Instant startOfYearMoment = Instant.ofEpochSecond(startOfYear).plusSeconds((60*60)*(userTimezone));

        // и текущую дату
        Instant thisMoment = Instant.now();

        // и конечную дату нашего графика рассветов и закатов (плюс семь дней)
        Instant lastMoment = thisMoment.plusSeconds(60*60*24*7);
        ...
        do {
            ...
            count++;
        } while (count <= 6); // вам нужно вывести график на семь дней
    ...
    private static int dayOfYearFromInstant(Instant startOfYear, Instant time) {
        ...
        return (int) fromStartOfYear / (60*60*24);
    }
